...
export default function Footer() {
  ...
  return (
    <footer className={`${theme === 'dark' ? 'bg-primary-navy/50' : 'bg-gray-50'} border-t ${theme === 'dark' ? 'border-white/10' : 'border-gray-200'}`} role="contentinfo">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid lg:grid-cols-5 gap-8 mb-12">
          <div className="lg:col-span-2">
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              {badges.map((badge, i) => (
                <span key={i} className="flex items-center space-x-1 px-3 py-1 rounded-full text-xs font-medium bg-white/5 border border-white/10">
              ...
              {footerLinks.resources.map((link, i) => (
                <li key={i}>
                  <a
                    ...
                    className="text-white/70 hover:text-accent-green transition-colors text-sm flex items-center space-x-1"
                  >
        ...
        <div className="pt-8 border-t border-white/10">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            <div className="flex items-center justify-center lg:justify-start space-x-6">
              {socialLinks.map((social, i) => (
                <a
                  ...
                  className="p-2 rounded-xl bg-white/5 hover:bg-accent-green/10 text-white/60 hover:text-accent-green transition-colors"
            ...
            <div className="flex flex-col items-center lg:items-end space-y-2 text-sm text-white/50">
